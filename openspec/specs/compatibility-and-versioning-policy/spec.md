...
Система SHALL мати формалізовану policy сумісності для minor-релізів із явними правилами behavioral/API stability, включно з критеріями для namespace/temporal-window alignment змін.
...
Система MUST публікувати deprecation windows для parity-alignment змін і прив’язувати їх до release notes/migration guidance з явним impact описом.
...
Система SHALL вимагати migration notes і validation evidence для будь-яких **BREAKING** змін перед release, включно з differential parity і performance impact evidence.

#### Scenario: Gate release with breaking change checklist
- **WHEN** реліз включає breaking update
- **THEN** pipeline блокує випуск без завершеної migration документації, compatibility checks і required evidence
