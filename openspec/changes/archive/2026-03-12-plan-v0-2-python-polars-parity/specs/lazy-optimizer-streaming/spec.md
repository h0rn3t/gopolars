...
Система SHALL підтримувати rule set для projection/predicate pushdown, constant folding, expression simplification, join reordering і plan normalization згідно parity profile.
...
Система SHALL виконувати streaming-friendly pipelines для великих наборів даних з bounded-memory strategy і deterministic outputs.
